...
export default function RegisterScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <Text style={{ textAlign: "center", color: colors.text, fontSize: 18, marginVertical: 15 }}>
        Create an Account
      </Text>
      ...
      <View style={styles.content}>
        ...
        <View style={{ width: "100%", position: "relative" }}>
          ...
          <TouchableOpacity
            ...
            onPress={() => setShowPassword(!showPassword)}
          >
            <AntIcon name={showPassword ? "eyeo" : "eye"} size={22} color={colors.text} />
          </TouchableOpacity>
        </View>
        ...
        <View style={{ width: "100%", position: "relative" }}>
          ...
          <TouchableOpacity
            ...
            onPress={() => setShowConfirmPassword(!showConfirmPassword)}
          >
            <AntIcon name={showConfirmPassword ? "eyeo" : "eye"} size={20} color={colors.text} />
          </TouchableOpacity>
        </View>

        <TouchableOpacity style={[styles.loginButton, { backgroundColor: colors.primary }]} onPress={handleRegister}>
          <Text style={[styles.loginButtonText, { color: colors.background }]}>Register</Text>
        </TouchableOpacity>

        <View style={styles.registerRow}>
          <Text style={[styles.registerText, { color: colors.subtext }]}>Already have an account?</Text>
          <TouchableOpacity onPress={() => navigation.navigate("Login")}>
            <Text style={[styles.registerLink, { color: colors.text }]}> Login here</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  topImage: { width: width, height: 220 },
  content: { flex: 1, alignItems: "center", paddingHorizontal: 24, paddingTop: 20 },
  label: { alignSelf: "flex-start", marginBottom: 5, fontSize: 14 },
